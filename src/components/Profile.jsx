      ...
      <div className="  flex justify-around ">
        <div className="flex flex-col ">
          ...
          <h1 className=" font-bold text-4xl flex ">
            {" "}
            Software Developer.
            <p className=" animate-bounce text-[#7c3aed] text-4xl">.</p>
          </h1>
          <div className="mt-5">
            <a
              href="https://drive.google.com/file/d/166l25GHj9-7xgLL-EmW6FAmDN8i0C0yH/view"
              className="bg-[#7c3aed] w-fit p-2 rounded-md text-4xl cursor-pointer "
            >
              Resume.
            </a>
          </div>
        ...
        <div className="cursor-pointer">
          <img
            className="rounded-[50%]  h-[250px] border-[#7c3aed] border-[4px]"
            src={MyPic}
          />
        </div>
      </div>
